...
public class MAXSwerveModule implements SwerveModule {
    ...
    public MAXSwerveModule(int drivingCANId, int turningCANId, double chassisAngularOffset) {
        CANSparkMax drivingSparkMax = new CANSparkMax(drivingCANId, CANSparkLowLevel.MotorType.kBrushless);
        turningSparkMax = new CANSparkMax(turningCANId, CANSparkLowLevel.MotorType.kBrushless);
